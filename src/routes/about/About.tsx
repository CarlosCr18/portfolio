      ...
      skills: [
        {
          ...
          alt: "Git Icon",
          title: "GitHub 1.5 years of experience, GitLab less than 1 year of experience.",
        },
        {
      ...
      <div className={styles.container}>
        <div className={styles.aboutText}>
          ...
          <p className={styles.aboutTextBottom}>
            I'm a self-taught developer with passion for websites and applications development, I love learning new technologies. I focus on
            full stack web development with a stronger front end
          </p>
        </div>
        <Carousel
          ...
          {skillsData.map((sk, index) => (
            <AboutSkills key={sk.title + "_" + index} skillsData={sk}></AboutSkills>
          ))}
        </Carousel>
      </div>
    </div>
